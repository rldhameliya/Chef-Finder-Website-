            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main">
                    <div class="col-sm-12 col-md-12 well" id="content">
                        <!-- <h1 align="center">Available Chef...</h1> -->
                        <?php
...
$query = "select * from cheffinder where Email_ID=\"$email\" and Password=\"$pwd\" ";
...
while($result=mysqli_fetch_assoc($data)){
 ...
 <tr class='panel panel'>
     ...
     <td><a href = 'delete.php?i=$result[ID] 'class='btn btn-danger'>Delete</a></td>
     </tr> ";
...
echo "</table>";
       ...
       $con = new mysqli('localhost', "root", "", "cheffinder");
       $query = "SELECT * FROM `chef` ORDER BY chef.ID ASC";
       $data = mysqli_query($con,$query);
       $total = mysqli_num_rows($data);
       
       echo "<h2> Available Chefs... </h2>";
       echo "<br>";
       echo "<table  cellspacing:='12' class='table'>";
       echo "<tr class='panel-heading'>";
       echo "<th> ID </th>";
